...
#define FLAG_PARTY_MOVES     0x20 // Unused Flag Now for In-Party Relearner
#define FLAG_RUN_TOGGLE      0x21 // Unused Flag for Running Shoes Goodness
...
#define FLAG_SKIP_INTRO                                             0x493 // Unused Flag Now for Skip Intro Toggle
