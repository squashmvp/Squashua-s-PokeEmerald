...
#define EVO_MOVE_KNOWN       5  // Pokémon is traded changed to Pokemon levels up while knowing Move
#define EVO_TRADE            6  // Pokémon is traded while it's holding the specified item CHANGED to basis trade evo
...
#define EVO_TRADE_ITEM       16 // Pokemon is traded while it's holding the specified item
