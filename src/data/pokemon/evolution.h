const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_WARTORTLE]  = {{EVO_LEVEL, 36, SPECIES_BLASTOISE},
                            {EVO_ITEM, ITEM_DEVO_STONE, SPECIES_SQUIRTLE}},
    [SPECIES_BLASTOISE]  = {{EVO_ITEM, ITEM_DEVO_STONE, SPECIES_WARTORTLE}},
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_MOVE_KNOWN, MOVE_BOUNCE, SPECIES_POLITOED},
    ...
    [SPECIES_KADABRA]    = {{EVO_MOVE_KNOWN, MOVE_FUTURE_SIGHT, SPECIES_ALAKAZAM},
    ...
    [SPECIES_MACHOKE]    = {{EVO_MOVE_KNOWN, MOVE_CROSS_CHOP, SPECIES_MACHAMP},
    ...
    [SPECIES_WEEPINBELL] = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VICTREEBEL},
                            {EVO_ITEM, ITEM_DEVO_STONE, SPECIES_BELLSPROUT}},
    [SPECIES_VICTREEBEL] = {{EVO_ITEM, ITEM_DEVO_STONE, SPECIES_WEEPINBELL}},
    ...
    [SPECIES_GRAVELER]   = {{EVO_MOVE_KNOWN, MOVE_EXPLOSION, SPECIES_GOLEM},
                            {EVO_ITEM, ITEM_DEVO_STONE, SPECIES_GEODUDE}},
    [SPECIES_GOLEM]      = {{EVO_ITEM, ITEM_DEVO_STONE, SPECIES_GRAVELER}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_MOVE_KNOWN, MOVE_AMNESIA, SPECIES_SLOWKING}},
    ...
    [SPECIES_HAUNTER]    = {{EVO_MOVE_KNOWN, MOVE_NIGHTMARE, SPECIES_GENGAR},
                            {EVO_ITEM, ITEM_DEVO_STONE, SPECIES_GASTLY}},
    [SPECIES_GENGAR]     = {{EVO_ITEM, ITEM_DEVO_STONE, SPECIES_HAUNTER}},
    [SPECIES_ONIX]       = {{EVO_MOVE_KNOWN, MOVE_IRON_DEFENSE, SPECIES_STEELIX}},
    ...
    [SPECIES_SEADRA]     = {{EVO_MOVE_KNOWN, MOVE_DRAGON_DANCE, SPECIES_KINGDRA},
                            {EVO_ITEM, ITEM_DEVO_STONE, SPECIES_HORSEA}},
    [SPECIES_KINGDRA]    = {{EVO_ITEM, ITEM_DEVO_STONE, SPECIES_SEADRA}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_MOVE_KNOWN, MOVE_STEEL_WING, SPECIES_SCIZOR}},
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            {EVO_MOVE_KNOWN, MOVE_MORNING_SUN, SPECIES_ESPEON},
                            {EVO_MOVE_KNOWN, MOVE_MOONLIGHT, SPECIES_UMBREON}},
    ...
    [SPECIES_PORYGON]    = {{EVO_MOVE_KNOWN, MOVE_CONVERSION_2, SPECIES_PORYGON2}},
    [SPECIES_PORYGON2]   = {{EVO_MOVE_KNOWN, MOVE_SHARPEN, SPECIES_PORYGON}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_MOVE_KNOWN, MOVE_DIVE, SPECIES_HUNTAIL},
                            {EVO_MOVE_KNOWN, MOVE_WATERFALL, SPECIES_GOREBYSS}},
