...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty2[] = {
    ...
    .moves = {MOVE_SANDSTORM, MOVE_CRUNCH, MOVE_ROCK_SLIDE, MOVE_THRASH}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_MUD_SLAP, MOVE_SAND_ATTACK, MOVE_POISON_STING}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_FORRETRESS,
    .moves = {MOVE_SPIKES, MOVE_RAPID_SPIN, MOVE_PROTECT, MOVE_TAKE_DOWN}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_ARIADOS,
    .moves = {MOVE_NIGHT_SHADE, MOVE_POISON_STING, MOVE_LEECH_LIFE, MOVE_CONSTRICT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty3[] = {
    ...
    .lvl = 42,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SANDSTORM, MOVE_SAND_ATTACK, MOVE_POISON_STING}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_FORRETRESS,
    .moves = {MOVE_SPIKES, MOVE_RAPID_SPIN, MOVE_BIDE, MOVE_TAKE_DOWN}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_ARIADOS,
    .moves = {MOVE_NIGHT_SHADE, MOVE_POISON_STING, MOVE_LEECH_LIFE, MOVE_SPIDER_WEB}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .moves = {MOVE_MAGNITUDE, MOVE_DEFENSE_CURL, MOVE_ROCK_BLAST, MOVE_ROLLOUT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty4[] = {
    ...
    .lvl = 51,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SANDSTORM, MOVE_SAND_TOMB, MOVE_POISON_STING}
    },
    {
    .iv = 255,
    .lvl = 51,
    ...
    .lvl = 51,
    .species = SPECIES_GOLEM,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_DEFENSE_CURL, MOVE_ROCK_BLAST, MOVE_ROLLOUT}
    },
    {
    .iv = 255,
    .lvl = 51,
    ...
    .moves = {MOVE_WATER_GUN, MOVE_ANCIENT_POWER, MOVE_FURY_CUTTER, MOVE_METAL_CLAW}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty5[] = {
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_ROCK_SLIDE, MOVE_ROCK_SMASH}
    },
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_ARIADOS,
    .moves = {MOVE_PSYCHIC, MOVE_SLUDGE_BOMB, MOVE_LEECH_LIFE, MOVE_SPIDER_WEB}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_FORRETRESS,
    .moves = {MOVE_SPIKES, MOVE_EXPLOSION, MOVE_BIDE, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .lvl = 61,
    .species = SPECIES_ARMALDO,
    .moves = {MOVE_ROCK_BLAST, MOVE_ANCIENT_POWER, MOVE_FURY_CUTTER, MOVE_METAL_CLAW}
    },
    {
    .iv = 255,
    .lvl = 61,
    .species = SPECIES_GOLEM,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_ROCK_BLAST, MOVE_EXPLOSION}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .lvl = 54,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_THUNDER, MOVE_AGILITY, MOVE_CHARGE, MOVE_FAKE_TEARS}
    },
    {
    .iv = 250,
    .lvl = 54,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_TRI_ATTACK, MOVE_THUNDERBOLT, MOVE_METAL_SOUND, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 250,
    .lvl = 54,
    .species = SPECIES_AMPHAROS,
    .moves = {MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_LIGHT_SCREEN, MOVE_COTTON_SPORE}
    },
    {
    .iv = 250,
    .lvl = 54,
    .species = SPECIES_MINUN,
    .moves = {MOVE_THUNDER, MOVE_AGILITY, MOVE_HELPING_HAND, MOVE_BATON_PASS}
    },
    {
    .iv = 250,
    .lvl = 54,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_BITE, MOVE_THUNDER_WAVE, MOVE_ROAR, MOVE_THUNDER}
    },
    {
    .iv = 250,
    .lvl = 54,
    .species = SPECIES_EXPLOUD,
    .moves = {MOVE_REST, MOVE_SLEEP_TALK, MOVE_SUPERSONIC, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Ricky2[] = {
    ...
    .moves = {MOVE_SURF, MOVE_SUPERSONIC, MOVE_WING_ATTACK, MOVE_MIST}
    },
    {
    .iv = 255,
    .lvl = 27,
    ...
    .moves = {MOVE_FAKE_TEARS, MOVE_POISON_FANG, MOVE_BITE, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 27,
    ...
    .moves = {MOVE_SURF, MOVE_SLAM, MOVE_THUNDERBOLT, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Ricky3[] = {
    ...
    .species = SPECIES_MAWILE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_RAIN_DANCE, MOVE_FAKE_TEARS, MOVE_POISON_FANG, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 35,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_STAR_PIECE,
    .moves = {MOVE_FURY_SWIPES, MOVE_PIN_MISSILE, MOVE_TAIL_WHIP, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 35,
    ...
    .moves = {MOVE_SURF, MOVE_IRON_TAIL, MOVE_METAL_CLAW, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 36,
    ...
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_LIGHT_BALL,
    .moves = {MOVE_SURF, MOVE_SLAM, MOVE_THUNDER, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Ricky4[] = {
    ...
    .moves = {MOVE_SURF, MOVE_TAKE_DOWN, MOVE_ROCK_BLAST, MOVE_HORN_DRILL}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_MAWILE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_RAIN_DANCE, MOVE_FAKE_TEARS, MOVE_POISON_FANG, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_LIGHT_BALL,
    .moves = {MOVE_SURF, MOVE_SLAM, MOVE_THUNDER, MOVE_VOLT_TACKLE}
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .moves = {MOVE_SURF, MOVE_IRON_TAIL, MOVE_METAL_SOUND, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_TM44_REST,
    .moves = {MOVE_SLASH, MOVE_FURY_CUTTER, MOVE_BELLY_DRUM, MOVE_SURF}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Ricky5[] = {
    ...
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_LIGHT_BALL,
    .moves = {MOVE_SURF, MOVE_BRICK_BREAK, MOVE_THUNDER, MOVE_VOLT_TACKLE}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_RHYDON,
    .heldItem = ITEM_STARF_BERRY,
    .moves = {MOVE_SURF, MOVE_DOUBLE_EDGE, MOVE_ROCK_BLAST, MOVE_MEGAHORN}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .moves = {MOVE_BELLY_DRUM, MOVE_REST, MOVE_DOUBLE_EDGE, MOVE_SURF}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy1[] = {
    ...
    .moves = {MOVE_TACKLE, MOVE_TAIL_WHIP, MOVE_GROWL, MOVE_EXTREME_SPEED}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy2[] = {
    ...
    .species = SPECIES_ZIGZAGOON,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_HEADBUTT, MOVE_TAIL_WHIP, MOVE_ICY_WIND, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 22,
    ...
    .moves = {MOVE_QUICK_ATTACK, MOVE_CURSE, MOVE_IRON_TAIL, MOVE_ODOR_SLEUTH}
    },
    {
    .iv = 255,
    .lvl = 22,
    ...
    .heldItem = ITEM_STAR_PIECE,
    .moves = {MOVE_LICK, MOVE_ROAR, MOVE_ODOR_SLEUTH, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 23,
    .species = SPECIES_BAYLEEF,
    .heldItem = ITEM_PEARL,
    .moves = {MOVE_FRENZY_PLANT, MOVE_GROWL, MOVE_SYNTHESIS, MOVE_ANCIENT_POWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy3[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_HEADBUTT, MOVE_PIN_MISSILE, MOVE_ICY_WIND, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 32,
    ...
    .heldItem = ITEM_STARDUST,
    .moves = {MOVE_QUICK_ATTACK, MOVE_CURSE, MOVE_IRON_TAIL, MOVE_FIRE_BLAST}
    },
    {
    .iv = 255,
    .lvl = 32,
    ...
    .moves = {MOVE_TWISTER, MOVE_RECOVER, MOVE_WATER_PULSE, MOVE_WRAP}
    },
    {
    .iv = 255,
    .lvl = 30,
    ...
    .moves = {MOVE_HAZE, MOVE_MUD_SHOT, MOVE_SILVER_WIND, MOVE_PSYBEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy4[] = {
    ...
    .species = SPECIES_FLAREON,
    .heldItem = ITEM_STARDUST,
    .moves = {MOVE_TAKE_DOWN, MOVE_CURSE, MOVE_IRON_TAIL, MOVE_FIRE_SPIN}
    },
    {
    .iv = 255,
    .lvl = 36,
    ...
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_HEART_SCALE,
    .moves = {MOVE_ATTRACT, MOVE_RECOVER, MOVE_WATER_PULSE, MOVE_WRAP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy5[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_SLASH, MOVE_PIN_MISSILE, MOVE_ICY_WIND, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .species = SPECIES_MEGANIUM,
    .heldItem = ITEM_PEARL,
    .moves = {MOVE_FRENZY_PLANT, MOVE_REFLECT, MOVE_SYNTHESIS, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 255,
    .lvl = 44,
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_DIG, MOVE_PIN_MISSILE, MOVE_BELLY_DRUM, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 54,
    ...
    .species = SPECIES_GRANBULL,
    .heldItem = ITEM_STAR_PIECE,
    .moves = {MOVE_LICK, MOVE_TAKE_DOWN, MOVE_ODOR_SLEUTH, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica2[] = {
    ...
    .moves = {MOVE_SWEET_SCENT, MOVE_SLEEP_POWDER, MOVE_MAGICAL_LEAF, MOVE_ABSORB}
    },
    {
    .iv = 255,
    .lvl = 37,
    ...
    .lvl = 37,
    .species = SPECIES_MILOTIC,
    .moves = {MOVE_RECOVER, MOVE_TWISTER, MOVE_WATER_PULSE, MOVE_WRAP}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica3[] = {
    ...
    .lvl = 45,
    .species = SPECIES_MILOTIC,
    .moves = {MOVE_RECOVER, MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_WRAP}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_BELLOSSOM,
    .moves = {MOVE_MEGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_MAGICAL_LEAF, MOVE_PETAL_DANCE}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_POISON_TAIL, MOVE_POISON_FANG, MOVE_GLARE, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_BIND, MOVE_LICK, MOVE_SUBSTITUTE, MOVE_FAINT_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica4[] = {
    ...
    .lvl = 53,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_BIND, MOVE_THUNDER_WAVE, MOVE_RAIN_DANCE, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_SKARMORY,
    .moves = {MOVE_SPIKES, MOVE_STEEL_WING, MOVE_METAL_SOUND, MOVE_WING_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_MILOTIC,
    .moves = {MOVE_RECOVER, MOVE_ATTRACT, MOVE_WATER_PULSE, MOVE_WRAP}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_BELLOSSOM,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_RAIN_DANCE, MOVE_PETAL_DANCE}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_HAZE, MOVE_POISON_FANG, MOVE_GLARE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica5[] = {
    ...
    .lvl = 63,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_BIND, MOVE_THUNDER_WAVE, MOVE_SUBSTITUTE, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_MASQUERAIN,
    .moves = {MOVE_WHIRLWIND, MOVE_MIST, MOVE_STUN_SPORE, MOVE_SILVER_WIND}
    },
    {
    .iv = 255,
    .lvl = 63,
    ...
    .lvl = 63,
    .species = SPECIES_BELLOSSOM,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_LEECH_SEED, MOVE_PETAL_DANCE}
    },
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_SWAGGER, MOVE_POISON_FANG, MOVE_GLARE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winston5[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_BODY_SLAM, MOVE_SUBSTITUTE, MOVE_ROCK_SMASH, MOVE_SHADOW_BALL}
    },
    {
    .iv = 255,
    .lvl = 47,
    .species = SPECIES_PORYGON2,
    .heldItem = ITEM_PEARL,
    .moves = {MOVE_PSYBEAM, MOVE_RECOVER, MOVE_TRI_ATTACK, MOVE_ZAP_CANNON}
    },
    {
    .iv = 255,
    .lvl = 47,
    .species = SPECIES_SHUCKLE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_CONSTRICT, MOVE_EARTHQUAKE, MOVE_STRENGTH}
    },
    {
    .iv = 255,
    .lvl = 47,
    ...
    .heldItem = ITEM_STARDUST,
    .moves = {MOVE_HYPER_BEAM, MOVE_SCREECH, MOVE_FIRE_PUNCH, MOVE_DRAGON_CLAW}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_STAR_PIECE,
    .moves = {MOVE_EXPLOSION, MOVE_EXTRASENSORY, MOVE_LEECH_SEED, MOVE_RAZOR_WIND}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_BIG_PEARL,
    .moves = {MOVE_FLAMETHROWER, MOVE_SKY_UPPERCUT, MOVE_BLAZE_KICK, MOVE_SKY_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Joshua[] = {
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_FEAROW,
    .moves = {MOVE_SANDSTORM, MOVE_SAFEGUARD, MOVE_DRILL_PECK, MOVE_MIRROR_MOVE}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_SHUCKLE,
    .moves = {MOVE_SAND_TOMB, MOVE_ENCORE, MOVE_TOXIC, MOVE_LEECH_LIFE}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_CACTURNE,
    .moves = {MOVE_SOLAR_BEAM, MOVE_NEEDLE_ARM, MOVE_FAINT_ATTACK, MOVE_COTTON_SPORE}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_ONIX,
    .moves = {MOVE_SAND_TOMB, MOVE_BIND, MOVE_ROCK_SLIDE, MOVE_DIG}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_HOUNDOOM,
    .moves = {MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_SUNNY_DAY, MOVE_FIRE_SPIN}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_DUNSPARCE,
    .moves = {MOVE_ICE_BEAM, MOVE_GLARE, MOVE_BODY_SLAM, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter3[] = {
    ...
    .moves = {MOVE_FLAME_WHEEL, MOVE_AGILITY, MOVE_BITE, MOVE_EMBER}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_GOLDUCK,
    .moves = {MOVE_FURY_SWIPES, MOVE_CONFUSION, MOVE_DISABLE, MOVE_TAIL_WHIP}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_DONPHAN,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_RAPID_SPIN, MOVE_TAKE_DOWN}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_CACTURNE,
    .moves = {MOVE_NEEDLE_ARM, MOVE_PIN_MISSILE, MOVE_INGRAIN, MOVE_LEECH_SEED}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_THUNDER, MOVE_QUICK_ATTACK, MOVE_BITE, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter4[] = {
    ...
    .lvl = 53,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_THUNDERBOLT, MOVE_QUICK_ATTACK, MOVE_BITE, MOVE_THUNDER}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_DONPHAN,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_EARTHQUAKE, MOVE_TAKE_DOWN}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_SLASH, MOVE_MIMIC, MOVE_ICY_WIND, MOVE_BELLY_DRUM}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_GOLDUCK,
    .moves = {MOVE_FURY_SWIPES, MOVE_PSYCHIC, MOVE_DISABLE, MOVE_TAIL_WHIP}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_CACTURNE,
    .moves = {MOVE_NEEDLE_ARM, MOVE_PIN_MISSILE, MOVE_FAINT_ATTACK, MOVE_TEETER_DANCE}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_ARCANINE,
    .moves = {MOVE_FLAME_WHEEL, MOVE_AGILITY, MOVE_BITE, MOVE_EXTREME_SPEED}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRILL_PECK, MOVE_FAINT_ATTACK, MOVE_NIGHT_SHADE, MOVE_TAUNT}
    },
    {
    .iv = 250,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_NIGHTMARE, MOVE_DREAM_EATER, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 250,
    .lvl = 49,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_BALL, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH, MOVE_TORMENT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .species = SPECIES_CLOYSTER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CLAMP, MOVE_SPIKES, MOVE_SPIKE_CANNON, MOVE_ICICLE_SPEAR}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_SIGNAL_BEAM, MOVE_HAIL, MOVE_SAFEGUARD}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .species = SPECIES_PILOSWINE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BLIZZARD, MOVE_AMNESIA, MOVE_HAIL, MOVE_EARTHQUAKE}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PERISH_SONG, MOVE_CONFUSE_RAY, MOVE_HAIL, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MIST_BALL, MOVE_CHARM, MOVE_PSYWAVE, MOVE_SAFEGUARD}
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LUSTER_PURGE, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE, MOVE_RECOVER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_SAND_TOMB, MOVE_ROCK_TOMB, MOVE_SANDSTORM, MOVE_LEECH_LIFE}
    },
    {
    .iv = 255,
    .lvl = 12,
    .species = SPECIES_ONIX,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BIND, MOVE_DEFENSE_CURL, MOVE_ROCK_THROW, MOVE_SANDSTORM}
    },
    {
    .iv = 255,
    .lvl = 13,
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_ROCK_TOMB, MOVE_WING_ATTACK, MOVE_SCREECH}
    },
    {
    .iv = 255,
    .lvl = 14,
    ...
    .moves = {MOVE_STOMP, MOVE_MUD_SLAP, MOVE_LEER, MOVE_ROCK_THROW}
    },
    {
    .iv = 255,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_TYROGUE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COUNTER, MOVE_KARATE_CHOP, MOVE_FOCUS_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 16,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FURY_ATTACK, MOVE_FURY_CUTTER, MOVE_LEER, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 20,
    .species = SPECIES_HITMONLEE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_MEDITATE, MOVE_JUMP_KICK, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 19,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_ELECTABUZZ,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LOW_KICK, MOVE_THUNDER_PUNCH, MOVE_SWIFT, MOVE_LEER}
    },
    {
    .iv = 255,
    .lvl = 24,
    .species = SPECIES_FLAAFFY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COTTON_SPORE, MOVE_GROWL, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 255,
    .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_PONYTA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAME_WHEEL, MOVE_TAKE_DOWN, MOVE_FIRE_SPIN, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 24,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_DOUBLE_KICK, MOVE_FOCUS_ENERGY, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 26,
    ...
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAME_WHEEL, MOVE_BITE, MOVE_SAFEGUARD, MOVE_AGILITY}
    },
    {
    .iv = 255,
    .lvl = 29,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_DUNSPARCE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_FACADE, MOVE_ROLLOUT, MOVE_YAWN}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLASH, MOVE_FAKE_OUT, MOVE_TAUNT, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AGILITY, MOVE_SWORDS_DANCE, MOVE_BATON_PASS, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_SUPERSONIC, MOVE_FORESIGHT, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 31,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLY, MOVE_HEAT_WAVE, MOVE_WING_ATTACK, MOVE_SMOKESCREEN}
    },
    {
    .iv = 255,
    .lvl = 33,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER, MOVE_SUPERPOWER, MOVE_COSMIC_POWER}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_XATU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_FLATTER, MOVE_NIGHT_SHADE, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SKILL_SWAP, MOVE_PSYCHIC, MOVE_YAWN, MOVE_PSYCH_UP}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .moves = {MOVE_SKILL_SWAP, MOVE_PSYBEAM, MOVE_PSYCH_UP, MOVE_TRICK}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_COSMIC_POWER, MOVE_PSYCHIC, MOVE_HYPNOSIS, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCH_UP, MOVE_SOLAR_BEAM, MOVE_PSYCHIC, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MIST, MOVE_BOUNCE, MOVE_WATER_PULSE, MOVE_PERISH_SONG}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_FERALIGATR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_PUNCH, MOVE_SUPERPOWER, MOVE_CRUNCH, MOVE_MUD_SPORT}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_WAILORD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WHIRLPOOL, MOVE_WATER_SPOUT, MOVE_AMNESIA, MOVE_MIST}
    },
    {
    .iv = 255,
    .lvl = 44,
    .species = SPECIES_SEAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_SURF, MOVE_MEGAHORN}
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WHIRLPOOL, MOVE_DIVE, MOVE_WATER_PULSE, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_RAIN_DANCE, MOVE_ICE_BEAM, MOVE_RECOVER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg2[] = {
    ...
    .lvl = 30,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_FAKE_OUT, MOVE_FOCUS_ENERGY, MOVE_ARM_THRUST, MOVE_KNOCK_OFF}
    },
    {
    .iv = 255,
    .lvl = 28,
    .species = SPECIES_PINECO,
    .moves = {MOVE_BIDE, MOVE_RAPID_SPIN, MOVE_TAKE_DOWN, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 30,
    .species = SPECIES_PIDGEOTTO,
    .moves = {MOVE_QUICK_ATTACK, MOVE_GUST, MOVE_WING_ATTACK, MOVE_WHIRLWIND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg3[] = {
    ...
    .lvl = 37,
    .species = SPECIES_FORRETRESS,
    .moves = {MOVE_SPIKES, MOVE_RAPID_SPIN, MOVE_TAKE_DOWN, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 39,
    .species = SPECIES_PIDGEOT,
    .moves = {MOVE_QUICK_ATTACK, MOVE_FEATHER_DANCE, MOVE_WING_ATTACK, MOVE_WHIRLWIND}
    },
    {
    .iv = 255,
    .lvl = 37,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_HEADBUTT, MOVE_COVET}
    },
    {
    .iv = 255,
    .lvl = 39,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_WHIRLWIND, MOVE_FOCUS_ENERGY, MOVE_ARM_THRUST, MOVE_KNOCK_OFF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg4[] = {
    ...
    .lvl = 47,
    .species = SPECIES_ESPEON,
    .moves = {MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_PSYCH_UP, MOVE_SWIFT}
    },
    {
    .iv = 255,
    .lvl = 49,
    .species = SPECIES_UMBREON,
    .moves = {MOVE_CURSE, MOVE_TOXIC, MOVE_CONFUSE_RAY, MOVE_ROAR}
    },
    {
    .iv = 255,
    .lvl = 47,
    ...
    .lvl = 47,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_GROWL, MOVE_BELLY_DRUM, MOVE_HEADBUTT, MOVE_COVET}
    },
    {
    .iv = 255,
    .lvl = 49,
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg5[] = {
    ...
    .lvl = 56,
    .species = SPECIES_FORRETRESS,
    .moves = {MOVE_SPIKES, MOVE_SAND_TOMB, MOVE_TOXIC, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 57,
...
static const struct TrainerMonNoItemCustomMoves sParty_Timothy2[] = {
    ...
    .lvl = 38,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_PSYCHIC, MOVE_ENDURE, MOVE_REVERSAL}
    },
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_WOBBUFFET,
    .moves = {MOVE_CHARM, MOVE_ENCORE, MOVE_COUNTER, MOVE_MIRROR_COAT}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .lvl = 38,
    .species = SPECIES_HERACROSS,
    .moves = {MOVE_COUNTER, MOVE_BRICK_BREAK, MOVE_FURY_ATTACK, MOVE_BIDE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Timothy3[] = {
    ...
    .lvl = 46,
    .species = SPECIES_WOBBUFFET,
    .moves = {MOVE_COUNTER, MOVE_MIRROR_COAT, MOVE_DESTINY_BOND, MOVE_CHARM}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_ARM_THRUST, MOVE_KNOCK_OFF, MOVE_BELLY_DRUM, MOVE_DIG}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_LEECH_SEED, MOVE_MEGA_DRAIN, MOVE_MACH_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_REVERSAL}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_HERACROSS,
    .moves = {MOVE_REVERSAL, MOVE_COUNTER, MOVE_BRICK_BREAK, MOVE_TAKE_DOWN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Timothy4[] = {
    ...
    .lvl = 54,
    .species = SPECIES_BLAZIKEN,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_BLAZE_KICK, MOVE_DOUBLE_KICK, MOVE_MIRROR_MOVE}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_MACH_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 54,
    ...
    .lvl = 54,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_ARM_THRUST, MOVE_KNOCK_OFF, MOVE_FOCUS_ENERGY, MOVE_DIG}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_HERACROSS,
    .moves = {MOVE_REVERSAL, MOVE_COUNTER, MOVE_BRICK_BREAK, MOVE_MEGAHORN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Timothy5[] = {
    ...
    .lvl = 62,
    .species = SPECIES_BLAZIKEN,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_BLAST_BURN, MOVE_DOUBLE_KICK, MOVE_SKY_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_REVERSAL}
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .lvl = 62,
    .species = SPECIES_HERACROSS,
    .moves = {MOVE_REVERSAL, MOVE_TAKE_DOWN, MOVE_BRICK_BREAK, MOVE_MEGAHORN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_SHOCK_WAVE, MOVE_FLAMETHROWER, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_PSYWAVE, MOVE_PSYBEAM, MOVE_PAIN_SPLIT, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 0,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao2[] = {
    ...
    .moves = {MOVE_POISON_POWDER, MOVE_SUPERSONIC, MOVE_CONFUSION, MOVE_LEECH_LIFE}
    },
    {
    .iv = 255,
    .lvl = 27,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_POISON_GAS, MOVE_FLAMETHROWER, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 255,
    .lvl = 27,
    .species = SPECIES_QUILAVA,
    .moves = {MOVE_FLAME_WHEEL, MOVE_CRUSH_CLAW, MOVE_REVERSAL, MOVE_SMOKESCREEN}
    },
    {
    .iv = 255,
    .lvl = 27,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao3[] = {
    ...
    .lvl = 38,
    .species = SPECIES_MUK,
    .moves = {MOVE_MINIMIZE, MOVE_ACID_ARMOR, MOVE_TOXIC, MOVE_DISABLE}
    },
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_TOXIC, MOVE_FLAMETHROWER, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .lvl = 38,
    .species = SPECIES_VENOMOTH,
    .moves = {MOVE_SILVER_WIND, MOVE_SUBSTITUTE, MOVE_CONFUSION, MOVE_LEECH_LIFE}
    },
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_ARBOK,
    .moves = {MOVE_ACID, MOVE_GLARE, MOVE_WRAP, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_TOXIC, MOVE_PSYBEAM, MOVE_PAIN_SPLIT, MOVE_PSYWAVE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao4[] = {
    ...
    .lvl = 48,
    .species = SPECIES_MUK,
    .moves = {MOVE_MINIMIZE, MOVE_ACID_ARMOR, MOVE_TOXIC, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = 255,
    .lvl = 48,
    ...
    .lvl = 48,
    .species = SPECIES_VENOMOTH,
    .moves = {MOVE_SILVER_WIND, MOVE_SUBSTITUTE, MOVE_PSYBEAM, MOVE_LEECH_LIFE}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_ARIADOS,
    .moves = {MOVE_FURY_SWIPES, MOVE_LEECH_LIFE, MOVE_NIGHT_SHADE, MOVE_STRING_SHOT}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Lao5[] = {
    ...
    .species = SPECIES_TYPHLOSION,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_FLAMETHROWER, MOVE_CRUSH_CLAW, MOVE_REVERSAL, MOVE_SMOKESCREEN}
    },
    {
    .iv = 255,
    .lvl = 60,
    ...
    .moves = {MOVE_TOXIC, MOVE_SUBSTITUTE, MOVE_PAIN_SPLIT, MOVE_PSYWAVE}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_ARIADOS,
    .heldItem = ITEM_SILVER_POWDER,
    .moves = {MOVE_PSYCHIC, MOVE_LEECH_LIFE, MOVE_NIGHT_SHADE, MOVE_STRING_SHOT}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .moves = {MOVE_SLUDGE_BOMB, MOVE_HAZE, MOVE_WRAP, MOVE_BITE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline2[] = {
    ...
    .lvl = 29,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_MEGA_DRAIN, MOVE_GRASS_WHISTLE, MOVE_LEECH_SEED, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 29,
    .species = SPECIES_TROPIUS,
    .moves = {MOVE_RAZOR_LEAF, MOVE_STOMP, MOVE_GUST, MOVE_GROWTH}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .lvl = 29,
    .species = SPECIES_SNORLAX,
    .moves = {MOVE_FIRE_PUNCH, MOVE_HEADBUTT, MOVE_YAWN, MOVE_CHARM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline3[] = {
    ...
    .lvl = 40,
    .species = SPECIES_LUDICOLO,
    .moves = {MOVE_FAKE_OUT, MOVE_FURY_SWIPES, MOVE_NATURE_POWER, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_GIGA_DRAIN, MOVE_GRASS_WHISTLE, MOVE_LEECH_SEED, MOVE_POISON_STING}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_QUAGSIRE,
    .moves = {MOVE_EARTHQUAKE, MOVE_RAIN_DANCE, MOVE_HYDRO_CANNON, MOVE_YAWN}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_SNORLAX,
    .moves = {MOVE_SURF, MOVE_HEADBUTT, MOVE_YAWN, MOVE_AMNESIA}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline4[] = {
    ...
    .lvl = 50,
    .species = SPECIES_LUDICOLO,
    .moves = {MOVE_FAKE_OUT, MOVE_HYDRO_PUMP, MOVE_NATURE_POWER, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_GIGA_DRAIN, MOVE_TOXIC, MOVE_LEECH_SEED, MOVE_PETAL_DANCE}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_ERUPTION, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_TROPIUS,
    .moves = {MOVE_SOLAR_BEAM, MOVE_SYNTHESIS, MOVE_FLY, MOVE_BODY_SLAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline5[] = {
    ...
    .lvl = 60,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_EARTHQUAKE, MOVE_ERUPTION, MOVE_FISSURE, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 60,
    ...
    .lvl = 60,
    .species = SPECIES_QUAGSIRE,
    .moves = {MOVE_EARTHQUAKE, MOVE_HAZE, MOVE_HYDRO_CANNON, MOVE_YAWN}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_SNORLAX,
    .moves = {MOVE_FLAMETHROWER, MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_GIGA_DRAIN, MOVE_TOXIC, MOVE_LEECH_SEED, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv5[] = {
    ...
    .lvl = 45,
    .species = SPECIES_AMPHAROS,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_LIGHT_SCREEN, MOVE_COTTON_SPORE, MOVE_BODY_SLAM}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_MINUN,
    .moves = {MOVE_BATON_PASS, MOVE_CHARGE, MOVE_AGILITY, MOVE_HELPING_HAND}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_FAKE_TEARS, MOVE_HELPING_HAND}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_HIDDEN_POWER, MOVE_ZAP_CANNON, MOVE_LOCK_ON, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv6[] = {
    ...
    .lvl = 53,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_THUNDER, MOVE_THUNDER_WAVE, MOVE_FAKE_TEARS, MOVE_HELPING_HAND}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_HIDDEN_POWER, MOVE_ZAP_CANNON, MOVE_LOCK_ON, MOVE_THUNDER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .moves = {MOVE_DOOM_DESIRE, MOVE_COSMIC_POWER, MOVE_PSYCHIC, MOVE_SWIFT}
    },
    {
    .iv = 255,
    .lvl = 44,
    ...
    .lvl = 43,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_CHARGE, MOVE_THUNDERBOLT, MOVE_BITE, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_MILOTIC,
    .moves = {MOVE_WHIRLPOOL, MOVE_RECOVER, MOVE_TWISTER, MOVE_REFRESH}
    },
    {
    .iv = 255,
    .lvl = 45,
...
static const struct TrainerMonNoItemCustomMoves sParty_KiraAndDan3[] = {
    {
    .iv = 255,
    .lvl = 35,
    .species = SPECIES_VOLBEAT,
    .moves = {MOVE_CONFUSE_RAY, MOVE_WATER_PULSE, MOVE_TAIL_GLOW, MOVE_SIGNAL_BEAM}
    },
    {
    .iv = 255,
    .lvl = 35,
    .species = SPECIES_ILLUMISE,
    .moves = {MOVE_WISH, MOVE_CHARM, MOVE_ATTRACT, MOVE_QUICK_ATTACK}
    }
};

static const struct TrainerMonNoItemCustomMoves sParty_KiraAndDan4[] = {
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_VOLBEAT,
    .moves = {MOVE_SHOCK_WAVE, MOVE_WATER_PULSE, MOVE_TAIL_GLOW, MOVE_SIGNAL_BEAM}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_ILLUMISE,
    .moves = {MOVE_WISH, MOVE_ENCORE, MOVE_HELPING_HAND, MOVE_QUICK_ATTACK}
    }
};

static const struct TrainerMonNoItemCustomMoves sParty_KiraAndDan5[] = {
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_VOLBEAT,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_TAIL_GLOW, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_ILLUMISE,
    .moves = {MOVE_FLATTER, MOVE_ENCORE, MOVE_HELPING_HAND, MOVE_COVET}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR2[] = {
    ...
    .lvl = 48,
    .species = SPECIES_JIRACHI,
    .moves = {MOVE_DOOM_DESIRE, MOVE_COSMIC_POWER, MOVE_PSYCHIC, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 47,
    ...
    .lvl = 49,
    .species = SPECIES_MILOTIC,
    .moves = {MOVE_WHIRLPOOL, MOVE_RECOVER, MOVE_WRAP, MOVE_SAFEGUARD}
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR3[] = {
    ...
    .lvl = 50,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_PERISH_SONG, MOVE_SAFEGUARD, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_JIRACHI,
    .moves = {MOVE_DOOM_DESIRE, MOVE_COSMIC_POWER, MOVE_PSYCHIC, MOVE_HYPER_VOICE}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .lvl = 49,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_ROAR, MOVE_THUNDERBOLT, MOVE_BITE, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 250,
    .lvl = 51,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR4[] = {
    ...
    .lvl = 53,
    .species = SPECIES_MILOTIC,
    .moves = {MOVE_WHIRLPOOL, MOVE_RECOVER, MOVE_ICE_BEAM, MOVE_SAFEGUARD}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_ROAR, MOVE_THUNDER, MOVE_BITE, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 250,
    .lvl = 54,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR5[] = {
    ...
    .lvl = 60,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_SKY_ATTACK, MOVE_SAFEGUARD, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_JIRACHI,
    .moves = {MOVE_DOOM_DESIRE, MOVE_COSMIC_POWER, MOVE_PSYCHIC, MOVE_HYPER_BEAM}
    },
    {
    .iv = 150,
    .lvl = 60,
    ...
    .lvl = 58,
    .species = SPECIES_MILOTIC,
    .moves = {MOVE_HYDRO_PUMP, MOVE_RECOVER, MOVE_ICE_BEAM, MOVE_SAFEGUARD}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay1[] = {
    ...
    .lvl = 39,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_FIRE_PUNCH, MOVE_PSYCH_UP, MOVE_PROTECT}
    },
    {
    .iv = 200,
    .lvl = 39,
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay3[] = {
    ...
    .lvl = 51,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_PSYCHIC, MOVE_PSYCH_UP, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_FAKE_OUT, MOVE_ROCK_TOMB, MOVE_VITAL_THROW, MOVE_BELLY_DRUM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay4[] = {
    ...
    .lvl = 56,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_SHADOW_BALL, MOVE_PSYCH_UP, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_FAKE_OUT, MOVE_ROCK_SLIDE, MOVE_REVERSAL, MOVE_BELLY_DRUM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_MAGNITUDE, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 33,
    ...
    .moves = {MOVE_ANCIENT_POWER, MOVE_SCARY_FACE, MOVE_WING_ATTACK, MOVE_SUPERSONIC}
    },
    {
    .iv = 255,
    .lvl = 33,
    ...
    .moves = {MOVE_IRON_TAIL, MOVE_EXPLOSION, MOVE_BIND, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 35,
    ...
    .heldItem = ITEM_STICK,
    .moves = {MOVE_MIMIC, MOVE_LOW_KICK, MOVE_ROCK_SLIDE, MOVE_SANDSTORM}
    },
    {
    .iv = 255,
    .lvl = 35,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_SPIKE_CANNON, MOVE_ROCK_BLAST, MOVE_RECOVER}
    },
    {
    .iv = 255,
    .lvl = 35,
    .species = SPECIES_NOSEPASS,
    .heldItem = ITEM_CHERI_BERRY,
    .moves = {MOVE_ROCK_SLIDE, MOVE_THUNDER_WAVE, MOVE_PROTECT, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne3[] = {
    ...
    .species = SPECIES_RHYHORN,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_HORN_DRILL, MOVE_SANDSTORM, MOVE_ROCK_TOMB, MOVE_SCARY_FACE}
    },
    {
    .iv = 255,
    .lvl = 44,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_EXPLOSION, MOVE_ROCK_TOMB, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 44,
    .species = SPECIES_SHUCKLE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_WRAP, MOVE_CONSTRICT, MOVE_LEECH_LIFE, MOVE_SAFEGUARD}
    },
    {
    .iv = 255,
    .lvl = 44,
    ...
    .moves = {MOVE_SANDSTORM, MOVE_INGRAIN, MOVE_GIGA_DRAIN, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 255,
    .lvl = 44,
    .species = SPECIES_NOSEPASS,
    .heldItem = ITEM_GANLON_BERRY,
    .moves = {MOVE_ZAP_CANNON, MOVE_EXPLOSION, MOVE_SANDSTORM, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .moves = {MOVE_METAL_CLAW, MOVE_FURY_CUTTER, MOVE_ANCIENT_POWER, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne4[] = {
    ...
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_SUNNY_DAY, MOVE_SCARY_FACE, MOVE_IRON_TAIL, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .moves = {MOVE_PROTECT, MOVE_FLAMETHROWER, MOVE_ROCK_SLIDE, MOVE_AMNESIA}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_CORSOLA,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_SANDSTORM, MOVE_ANCIENT_POWER, MOVE_MIRROR_COAT, MOVE_RECOVER}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_HYPER_BEAM, MOVE_WING_ATTACK, MOVE_ANCIENT_POWER, MOVE_SCARY_FACE}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .moves = {MOVE_ZAP_CANNON, MOVE_REST, MOVE_SANDSTORM, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_RHYDON,
    .heldItem = ITEM_STARF_BERRY,
    .moves = {MOVE_SCARY_FACE, MOVE_ROCK_SLIDE, MOVE_HORN_DRILL, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    ...
    .species = SPECIES_TYRANITAR,
    .heldItem = ITEM_BLACK_GLASSES,
    .moves = {MOVE_SANDSTORM, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_ROCK_TOMB}
    },
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_CRADILY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_INGRAIN, MOVE_AMNESIA, MOVE_ANCIENT_POWER, MOVE_SANDSTORM}
    },
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_ARMALDO,
    .heldItem = ITEM_GANLON_BERRY,
    .moves = {MOVE_ROCK_BLAST, MOVE_SLASH, MOVE_EARTHQUAKE, MOVE_FURY_CUTTER}
    },
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_OMASTAR,
    .heldItem = ITEM_APICOT_BERRY,
    .moves = {MOVE_HYDRO_CANNON, MOVE_TICKLE, MOVE_ANCIENT_POWER, MOVE_SPIKE_CANNON}
    },
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_SCARY_FACE, MOVE_BITE, MOVE_WING_ATTACK, MOVE_HYPER_BEAM}
    },
    {
    .iv = 255,
    .lvl = 72,
    .species = SPECIES_NOSEPASS,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_SANDSTORM, MOVE_ZAP_CANNON, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .species = SPECIES_PINSIR,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_VITAL_THROW, MOVE_ROCK_SMASH, MOVE_HARDEN, MOVE_BIND}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_COMBUSKEN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BLAZE_KICK, MOVE_DOUBLE_KICK, MOVE_PECK, MOVE_MEGA_KICK}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_HITMONCHAN,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_COMET_PUNCH, MOVE_MEGA_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_FORESIGHT, MOVE_CROSS_CHOP, MOVE_LEER, MOVE_REVENGE}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_POLIWRATH,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_BULK_UP, MOVE_SUBMISSION, MOVE_BODY_SLAM, MOVE_DOUBLE_SLAP}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_FOCUS_PUNCH, MOVE_MACH_PUNCH, MOVE_HEADBUTT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly3[] = {
    ...
    .species = SPECIES_HITMONTOP,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_TRIPLE_KICK, MOVE_MEGA_KICK, MOVE_ROLLING_KICK, MOVE_AGILITY}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_BODY_SLAM, MOVE_FOCUS_ENERGY, MOVE_ARM_THRUST, MOVE_SMELLING_SALT}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_SPORE, MOVE_GIGA_DRAIN, MOVE_GROWTH}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_PRIMEAPE,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_RAGE, MOVE_CROSS_CHOP, MOVE_FOCUS_ENERGY, MOVE_FURY_SWIPES}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_BULK_UP, MOVE_MIND_READER, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_CROSS_CHOP, MOVE_COUNTER, MOVE_SCARY_FACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .species = SPECIES_PINSIR,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_SEISMIC_TOSS, MOVE_BIND, MOVE_SWORDS_DANCE, MOVE_SUBMISSION}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_HITMONCHAN,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_DYNAMIC_PUNCH, MOVE_MEGA_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_SPORE, MOVE_BULK_UP, MOVE_MACH_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_HITMONLEE,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_REVERSAL, MOVE_ENDURE, MOVE_HI_JUMP_KICK, MOVE_DOUBLE_KICK}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_HITMONTOP,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_TRIPLE_KICK, MOVE_MEGA_KICK, MOVE_PURSUIT, MOVE_COUNTER}
    },
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_PRIMEAPE,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_KNOCK_OFF, MOVE_SCREECH, MOVE_CROSS_CHOP, MOVE_THRASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    ...
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_BLAZE_KICK, MOVE_SLASH, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 74,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_ENDURE}
    },
    {
    .iv = 255,
    .lvl = 74,
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_CROSS_CHOP, MOVE_SCARY_FACE, MOVE_DYNAMIC_PUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 72,
    ...
    .moves = {MOVE_BODY_SLAM, MOVE_BELLY_DRUM, MOVE_DYNAMIC_PUNCH, MOVE_HYPNOSIS}
    },
    {
    .iv = 255,
    .lvl = 72,
    .species = SPECIES_HERACROSS,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_MEGAHORN, MOVE_BRICK_BREAK, MOVE_COUNTER, MOVE_REVERSAL}
    },
    {
    .iv = 255,
    .lvl = 74,
    ...
    .moves = {MOVE_KNOCK_OFF, MOVE_ARM_THRUST, MOVE_FAKE_OUT, MOVE_REVERSAL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .moves = {MOVE_PIN_MISSILE, MOVE_DOUBLE_KICK, MOVE_QUICK_ATTACK, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_CHERI_BERRY,
    .moves = {MOVE_BITE, MOVE_THUNDER_WAVE, MOVE_THUNDER, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 36,
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDER, MOVE_EXPLOSION, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_SURF, MOVE_THUNDER, MOVE_WHIRLPOOL, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 36,
    .species = SPECIES_RAICHU,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_IRON_TAIL, MOVE_HIDDEN_POWER, MOVE_THUNDER, MOVE_DOUBLE_TEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson3[] = {
    ...
    .species = SPECIES_PLUSLE,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_SUBSTITUTE, MOVE_BATON_PASS, MOVE_AGILITY, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_MINUN,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_THUNDER, MOVE_RAIN_DANCE, MOVE_HELPING_HAND, MOVE_REFLECT}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .species = SPECIES_AMPHAROS,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_LIGHT_SCREEN, MOVE_COTTON_SPORE, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_SUPERSONIC, MOVE_TRI_ATTACK, MOVE_THUNDER, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 49,
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SURF, MOVE_THUNDER_WAVE, MOVE_WHIRLPOOL, MOVE_DIVE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = {
    ...
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_THUNDERBOLT, MOVE_MIRROR_COAT, MOVE_REFLECT, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_AMPHAROS,
    .heldItem = ITEM_STARF_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_COTTON_SPORE, MOVE_BRICK_BREAK, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_ELECTABUZZ,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH, MOVE_DYNAMIC_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BITE, MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_CHARGE}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_SUPERSONIC, MOVE_HIDDEN_POWER, MOVE_THUNDER, MOVE_METAL_SOUND}
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .moves = {MOVE_IRON_TAIL, MOVE_HIDDEN_POWER, MOVE_THUNDERBOLT, MOVE_DOUBLE_TEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson5[] = {
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DIVE, MOVE_THUNDER, MOVE_SURF, MOVE_WHIRLPOOL}
    },
    {
    .iv = 255,
    .lvl = 74,
    .species = SPECIES_RAICHU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_IRON_TAIL, MOVE_RAIN_DANCE, MOVE_REFLECT}
    },
    {
    .iv = 255,
    .lvl = 74,
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BITE, MOVE_HIDDEN_POWER, MOVE_THUNDER, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 255,
    .lvl = 74,
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_REFLECT, MOVE_THUNDER, MOVE_MIRROR_COAT, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 74,
    .species = SPECIES_JOLTEON,
    .heldItem = ITEM_RED_SCARF,
    .moves = {MOVE_THUNDER, MOVE_PIN_MISSILE, MOVE_THUNDER_WAVE, MOVE_DOUBLE_KICK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = {
    ...
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_IRON_DEFENSE, MOVE_FIRE_SPIN, MOVE_BODY_SLAM}
    },
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_FAINT_ATTACK, MOVE_BEAT_UP, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .moves = {MOVE_HELPING_HAND, MOVE_FIRE_SPIN, MOVE_BITE, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_TYPHLOSION,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_REVERSAL, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_CHARIZARD,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SCARY_FACE, MOVE_WING_ATTACK, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_DOUBLE_KICK, MOVE_EARTHQUAKE, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery3[] = {
    ...
    .species = SPECIES_TYPHLOSION,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_BLAST_BURN, MOVE_FURY_CUTTER, MOVE_REVERSAL}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_MENTAL_HERB,
    .moves = {MOVE_ATTRACT, MOVE_IMPRISON, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_ROCK_SLIDE, MOVE_ATTRACT, MOVE_FIRE_BLAST, MOVE_AMNESIA}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .species = SPECIES_FLAREON,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_FIRE_BLAST, MOVE_SMOG, MOVE_FIRE_SPIN, MOVE_MUD_SLAP}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_EXTREME_SPEED, MOVE_FLAME_WHEEL, MOVE_CRUNCH, MOVE_HEAT_WAVE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery4[] = {
    ...
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_APICOT_BERRY,
    .moves = {MOVE_HEAT_WAVE, MOVE_AMNESIA, MOVE_IRON_DEFENSE, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 64,
    .species = SPECIES_MAGMAR,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_CONFUSE_RAY, MOVE_SMOKESCREEN, MOVE_SMOG}
    },
    {
    .iv = 255,
    .lvl = 64,
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FIRE_BLAST, MOVE_EARTHQUAKE, MOVE_BODY_SLAM}
    },
    {
    .iv = 255,
    .lvl = 66,
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SKY_UPPERCUT, MOVE_SLASH, MOVE_MIRROR_MOVE}
    },
    {
    .iv = 255,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery5[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_MENTAL_HERB,
    .moves = {MOVE_IMPRISON, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 76,
    .species = SPECIES_CHARIZARD,
    .heldItem = ITEM_KINGS_ROCK,
    .moves = {MOVE_HEAT_WAVE, MOVE_DRAGON_RAGE, MOVE_BLAST_BURN, MOVE_WING_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 78,
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_CRUNCH, MOVE_SOLAR_BEAM, MOVE_TAUNT, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 77,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_GANLON_BERRY,
    .moves = {MOVE_HEAT_WAVE, MOVE_AMNESIA, MOVE_BODY_SLAM, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 78,
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_STRENGTH, MOVE_AGILITY, MOVE_CRUNCH, MOVE_HEAT_WAVE}
    },
    {
    .iv = 255,
    .lvl = 78,
    .species = SPECIES_FLAREON,
    .heldItem = ITEM_BLUE_SCARF,
    .moves = {MOVE_BLAST_BURN, MOVE_SMOG, MOVE_FIRE_SPIN, MOVE_MUD_SLAP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .species = SPECIES_GIRAFARIG,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_REFLECT, MOVE_PSYCHIC, MOVE_SKILL_SWAP, MOVE_SHADOW_BALL}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .moves = {MOVE_SHARPEN, MOVE_TRI_ATTACK, MOVE_CONVERSION, MOVE_PSYBEAM}
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .heldItem = ITEM_GANLON_BERRY,
    .moves = {MOVE_STOMP, MOVE_WRAP, MOVE_DISABLE, MOVE_ICY_WIND}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .species = SPECIES_KANGASKHAN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_DIZZY_PUNCH, MOVE_SURF, MOVE_CRUSH_CLAW}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman3[] = {
    ...
    .species = SPECIES_STANTLER,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_REFLECT, MOVE_CONFUSE_RAY, MOVE_STOMP, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_HYPER_VOICE, MOVE_REST, MOVE_SLEEP_TALK, MOVE_EXTRASENSORY}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_KECLEON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ANCIENT_POWER, MOVE_MAGIC_COAT, MOVE_PSYBEAM, MOVE_METRONOME}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_CRUSH_CLAW, MOVE_CURSE, MOVE_DOUBLE_KICK, MOVE_FURY_CUTTER}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_ENDEAVOR, MOVE_DREAM_EATER, MOVE_NIGHTMARE, MOVE_SPORE}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYPER_BEAM, MOVE_BLAST_BURN, MOVE_FRENZY_PLANT, MOVE_HYDRO_CANNON}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman4[] = {
    ...
    .species = SPECIES_DUNSPARCE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GLARE, MOVE_ENDEAVOR, MOVE_BLIZZARD, MOVE_DIG}
    },
    {
    .iv = 255,
    .lvl = 66,
    .species = SPECIES_GIRAFARIG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_REFLECT, MOVE_PSYBEAM, MOVE_SKILL_SWAP, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 68,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_AMNESIA, MOVE_SLACK_OFF, MOVE_FACADE, MOVE_BLIZZARD}
    },
    {
    .iv = 255,
    .lvl = 68,
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HEAL_BELL, MOVE_ASSIST, MOVE_COVET, MOVE_SWIFT}
    },
    {
    .iv = 255,
    .lvl = 66,
    ...
    .heldItem = ITEM_HARD_STONE,
    .moves = {MOVE_HYPER_BEAM, MOVE_REST, MOVE_SLEEP_TALK, MOVE_ROLLOUT}
    },
    {
    .iv = 255,
    .lvl = 66,
    .species = SPECIES_TAUROS,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_DOUBLE_EDGE, MOVE_SCARY_FACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman5[] = {
    ...
    .moves = {MOVE_SOFT_BOILED, MOVE_SING, MOVE_SKILL_SWAP, MOVE_METRONOME}
    },
    {
    .iv = 255,
    .lvl = 79,
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAKE_TEARS, MOVE_HYPER_VOICE, MOVE_THUNDER_PUNCH, MOVE_DYNAMIC_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_SNORLAX,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BELLY_DRUM, MOVE_YAWN, MOVE_REST, MOVE_SNORE}
    },
    {
    .iv = 255,
    .lvl = 78,
    .species = SPECIES_PORYGON2,
    .heldItem = ITEM_STARF_BERRY,
    .moves = {MOVE_PSYCH_UP, MOVE_TRI_ATTACK, MOVE_RECYCLE, MOVE_PSYBEAM}
    },
    {
    .iv = 255,
    .lvl = 82,
    ...
    .moves = {MOVE_SUPERPOWER, MOVE_PSYCH_UP, MOVE_TRI_ATTACK, MOVE_WISH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona2[] = {
    ...
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STOCKPILE, MOVE_SPIT_UP, MOVE_SWALLOW, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .heldItem = ITEM_SILVER_POWDER,
    .moves = {MOVE_WING_ATTACK, MOVE_SCREECH, MOVE_LEECH_LIFE, MOVE_SUPERSONIC}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_BODY_SLAM, MOVE_AERIAL_ACE, MOVE_MAGICAL_LEAF, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 44,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STEEL_WING, MOVE_AIR_CUTTER, MOVE_CURSE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .moves = {MOVE_PSYBEAM, MOVE_GUST, MOVE_SILVER_WIND, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_PSYBEAM, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_SILVER_WIND}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona3[] = {
    ...
    .species = SPECIES_MASQUERAIN,
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_MIST, MOVE_STUN_SPORE, MOVE_SILVER_WIND, MOVE_WHIRLWIND}
    },
    {
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_DRAGON_FANG,
    .moves = {MOVE_TWISTER, MOVE_DRAGON_DANCE, MOVE_STRENGTH, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_STICK,
    .moves = {MOVE_SWORDS_DANCE, MOVE_FURY_CUTTER, MOVE_AERIAL_ACE, MOVE_STEEL_WING}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .moves = {MOVE_HAZE, MOVE_DRAGON_BREATH, MOVE_ICE_BEAM, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_CHARIZARD,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_SUNNY_DAY, MOVE_HEAT_WAVE, MOVE_WING_ATTACK, MOVE_DRAGON_RAGE}
    },
    {
    .iv = 255,
    .lvl = 54,
    ...
    .moves = {MOVE_GUILLOTINE, MOVE_SAND_TOMB, MOVE_METAL_CLAW, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona4[] = {
    ...
    .species = SPECIES_TOGETIC,
    .heldItem = ITEM_SILK_SCARF,
    .moves = {MOVE_YAWN, MOVE_ROCK_SMASH, MOVE_FOLLOW_ME, MOVE_SECRET_POWER}
    },
    {
    .iv = 255,
    .lvl = 67,
    .species = SPECIES_DODRIO,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_DRILL_PECK, MOVE_SWORDS_DANCE, MOVE_JUMP_KICK, MOVE_FLAIL}
    },
    {
    .iv = 255,
    .lvl = 68,
    .species = SPECIES_PIDGEOT,
    .heldItem = ITEM_SHARP_BEAK,
    .moves = {MOVE_FEATHER_DANCE, MOVE_WING_ATTACK, MOVE_GUST, MOVE_MIRROR_MOVE}
    },
    {
    .iv = 255,
    .lvl = 67,
    .species = SPECIES_NOCTOWL,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_HYPNOSIS, MOVE_NIGHTMARE, MOVE_PSYCHIC, MOVE_REFLECT}
    },
    {
    .iv = 255,
    .lvl = 66,
    .species = SPECIES_FEAROW,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_DRILL_PECK, MOVE_TRI_ATTACK, MOVE_STEEL_WING, MOVE_SCARY_FACE}
    },
    {
    .iv = 255,
    .lvl = 68,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_DRAGON_FANG,
    .moves = {MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE, MOVE_SKY_ATTACK, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona5[] = {
    ...
    .species = SPECIES_PIDGEOT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FEATHER_DANCE, MOVE_WING_ATTACK, MOVE_MIRROR_MOVE, MOVE_WHIRLWIND}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_POISON_BARB,
    .moves = {MOVE_POISON_FANG, MOVE_TOXIC, MOVE_LEECH_LIFE, MOVE_CURSE}
    },
    {
    .iv = 255,
    .lvl = 80,
    ...
    .moves = {MOVE_WING_ATTACK, MOVE_STEEL_WING, MOVE_SWORDS_DANCE, MOVE_FURY_CUTTER}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_JUMPLUFF,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_HELPING_HAND, MOVE_AMNESIA}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_DODRIO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRILL_PECK, MOVE_SWORDS_DANCE, MOVE_JUMP_KICK, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_DRAGONITE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_OUTRAGE, MOVE_WING_ATTACK, MOVE_DRAGON_DANCE, MOVE_HYPER_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza2[] = {
    ...
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_HARD_STONE,
    .moves = {MOVE_YAWN, MOVE_PSYCHIC, MOVE_PSYCH_UP, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_HARD_STONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER, MOVE_COSMIC_POWER, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_SLOWKING,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_REST, MOVE_SKILL_SWAP, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 44,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_HIDDEN_POWER, MOVE_DETECT}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_ESPEON,
    .heldItem = ITEM_GREEN_SCARF,
    .moves = {MOVE_PSYCHIC, MOVE_AURORA_BEAM, MOVE_FLATTER, MOVE_PSYCH_UP}
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .moves = {MOVE_FUTURE_SIGHT, MOVE_DRILL_PECK, MOVE_CONFUSE_RAY, MOVE_WISH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza3[] = {
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_DOUBLE_TEAM, MOVE_PSYCHIC, MOVE_IMPRISON}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_PUNCH, MOVE_PSYCHIC, MOVE_SKILL_SWAP, MOVE_TRICK}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_APICOT_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_EARTHQUAKE, MOVE_COSMIC_POWER, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER, MOVE_COSMIC_POWER, MOVE_REST}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza4[] = {
    ...
    .species = SPECIES_GIRAFARIG,
    .heldItem = ITEM_FIGY_BERRY,
    .moves = {MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_STOMP, MOVE_TOXIC}
    },
    {
    .iv = 255,
    .lvl = 59,
    .species = SPECIES_ESPEON,
    .heldItem = ITEM_GREEN_SCARF,
    .moves = {MOVE_EXTRASENSORY, MOVE_DESTINY_BOND, MOVE_RECYCLE, MOVE_AURORA_BEAM}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_MR_MIME,
    .heldItem = ITEM_STARF_BERRY,
    .moves = {MOVE_REFLECT, MOVE_PSYBEAM, MOVE_RECYCLE, MOVE_ENCORE}
    },
    {
    .iv = 255,
    .lvl = 59,
    ...
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_REST, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_JYNX,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_LOVELY_KISS, MOVE_BLIZZARD, MOVE_PSYCHIC, MOVE_FAKE_TEARS}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza5[] = {
    ...
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_METEOR_MASH, MOVE_AGILITY, MOVE_ROCK_SLIDE, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RECOVER, MOVE_CONFUSE_RAY, MOVE_PSYCHIC, MOVE_ICY_WIND}
    },
    {
    .iv = 255,
    .lvl = 80,
    ...
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_FUTURE_SIGHT, MOVE_PSYCH_UP, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_GARDEVOIR,
    .heldItem = ITEM_STARF_BERRY,
    .moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_IMPRISON, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_ESPEON,
    .heldItem = ITEM_GREEN_SCARF,
    .moves = {MOVE_MORNING_SUN, MOVE_LUSTER_PURGE, MOVE_RECYCLE, MOVE_BITE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan2[] = {
    ...
    .species = SPECIES_SHARPEDO,
    .heldItem = ITEM_BLACK_GLASSES,
    .moves = {MOVE_SKULL_BASH, MOVE_SWAGGER, MOVE_SUPER_FANG, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_KINGLER,
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_CRABHAMMER, MOVE_GUILLOTINE, MOVE_DIG, MOVE_KNOCK_OFF}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_DEWGONG,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_HORN_DRILL, MOVE_PROTECT, MOVE_DIVE}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_STARF_BERRY,
    .moves = {MOVE_THIEF, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_TAUNT}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_FIGY_BERRY,
    .moves = {MOVE_CRABHAMMER, MOVE_GUILLOTINE, MOVE_TAUNT, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_QUAGSIRE,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_HAZE, MOVE_EARTHQUAKE, MOVE_BODY_SLAM, MOVE_ANCIENT_POWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan3[] = {
    ...
    .species = SPECIES_VAPOREON,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_HYDRO_PUMP, MOVE_ACID_ARMOR, MOVE_AURORA_BEAM, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_BLASTOISE,
    .heldItem = ITEM_FIGY_BERRY,
    .moves = {MOVE_RAIN_DANCE, MOVE_SKULL_BASH, MOVE_HYDRO_CANNON, MOVE_MUD_SPORT}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_WATER_PULSE, MOVE_PSYBEAM, MOVE_CROSS_CHOP, MOVE_HYPNOSIS}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_POLITOED,
    .heldItem = ITEM_KINGS_ROCK,
    .moves = {MOVE_HYPNOSIS, MOVE_ICE_BALL, MOVE_WATERFALL, MOVE_BOUNCE}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_TENTACRUEL,
    .heldItem = ITEM_GANLON_BERRY,
    .moves = {MOVE_BARRIER, MOVE_SLUDGE_BOMB, MOVE_WRAP, MOVE_HYDRO_PUMP}
    },
    {
    .iv = 255,
    .lvl = 59,
    .species = SPECIES_AZUMARILL,
    .heldItem = ITEM_APICOT_BERRY,
    .moves = {MOVE_SLAM, MOVE_ENCORE, MOVE_ROCK_SMASH, MOVE_MUD_SLAP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan4[] = {
    ...
    .heldItem = ITEM_HARD_STONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_REST, MOVE_SLEEP_TALK, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 71,
    .species = SPECIES_FERALIGATR,
    .heldItem = ITEM_NEVER_MELT_ICE,
    .moves = {MOVE_ICE_PUNCH, MOVE_FURY_CUTTER, MOVE_ANCIENT_POWER, MOVE_MUD_SPORT}
    },
    {
    .iv = 255,
    .lvl = 69,
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_SOFT_SAND,
    .moves = {MOVE_FISSURE, MOVE_FUTURE_SIGHT, MOVE_EARTHQUAKE, MOVE_HYDRO_PUMP}
    },
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_MANTINE,
    .heldItem = ITEM_KINGS_ROCK,
    .moves = {MOVE_TWISTER, MOVE_ROCK_SLIDE, MOVE_AGILITY, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 69,
    .species = SPECIES_SEAKING,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_PSYBEAM, MOVE_HORN_DRILL, MOVE_FLAIL, MOVE_WATERFALL}
    },
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_SLOWBRO,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_WATER_PULSE, MOVE_PSYCHIC, MOVE_ICE_PUNCH, MOVE_AMNESIA}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan5[] = {
    ...
    .species = SPECIES_CLOYSTER,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_SPIKES, MOVE_ICICLE_SPEAR, MOVE_SPIKE_CANNON, MOVE_CLAMP}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_PINK_SCARF,
    .moves = {MOVE_RECOVER, MOVE_WHIRLPOOL, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_QWILFISH,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TOXIC, MOVE_HAIL, MOVE_SPIKES, MOVE_PIN_MISSILE}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_GANLON_BERRY,
    .moves = {MOVE_BLIZZARD, MOVE_HAIL, MOVE_DIVE, MOVE_SHEER_COLD}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_LAPRAS,
    .heldItem = ITEM_APICOT_BERRY,
    .moves = {MOVE_SHEER_COLD, MOVE_CONFUSE_RAY, MOVE_DIVE, MOVE_HAIL}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_VAPOREON,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SUPERPOWER, MOVE_HYDRO_CANNON, MOVE_EXTRASENSORY, MOVE_CONFUSE_RAY}
    }
};
