...
const u8 gText_StopLearningMove2[] = _("Continue with teaching\n{STR_VAR_2}?");
...
const u8 gText_YaySmileEmoji[] = _("Yat{EMOJI_BIGSMILE}");
...
const u8 gText_MoveRelearnerStopTryingToTeachMove[] = _("Continue with teaching\n{STR_VAR_2}?");
...
const u8 gText_AshQty[] = _("Aah Qty:\n{STR_VAR_1}{PAUSE_UNTIL_PRESS}");
